...
class TrellisImageTo3DPipeline(Pipeline):
    ...
    def run_multi_image_with_voxel_count(
        ...
        Adaptive texture steps based on voxel count (hard-coded values, slightly lower):
        - voxels > 30000: 18 steps (large models)
        - voxels > 20000: 23 steps (medium-large models)
        - voxels > 10000: 28 steps (medium models)
        - voxels <= 10000: 38 steps (small models)
        ...
        # Adaptive texture steps based on voxel count (hard-coded values, slightly lower)
        if num_voxels > 30000:
            adjusted_slat_steps = 18
            print(f"Voxel count {num_voxels} > 30000: Using 18 texture steps (large model)")
        elif num_voxels > 20000:
            adjusted_slat_steps = 23
            print(f"Voxel count {num_voxels} > 20000: Using 23 texture steps (medium-large model)")
        elif num_voxels > 10000:
            adjusted_slat_steps = 28
            print(f"Voxel count {num_voxels} > 10000: Using 28 texture steps (medium model)")
        else:
            adjusted_slat_steps = 38
            print(f"Voxel count {num_voxels} <= 10000: Using 38 texture steps (small model)")
